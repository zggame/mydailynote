...
\end{equation}
Here we assume the energy difference between levels are larger than other energy scale and keeps only the one in resonance, $\phi_{0}$.  It is not hard to find
\begin{equation}
\chi_{c}=\frac{\phi_{0}}{E-\eta+E_{b}}\int{dr'}\,\phi_{0}^{*}(r')Y(r')\chi_{r'}
\end{equation}
...
\br{-\frac{\hbar^{2}}{2m_{r}}\frac{d^{2}}{dr^{2}}-U-E}\chi+\frac{1}{E-\eta+E_{b}}\int_{0}^{\infty}K(r\,r')\chi(r')dr'=0
\end{equation}
...
=\frac{2m_{r}/\hbar^{2}}{E-\eta+E_{b}}\int_{0}^{r_{c}}dr\int_{0}^{r_{c}}dr'\chi_{0}(r)K(rr')\chi(r')
\end{equation}
...
\begin{equation}
\nth{a_{s}}-\nth{a_{bg}}=\frac{2m_{r}/\hbar^{2}}{E-\eta+E_{b}}\int_{0}^{\infty}dr\int_{0}^{\infty}dr'\chi_{0}(r)K(rr')\chi(r')
\end{equation}
