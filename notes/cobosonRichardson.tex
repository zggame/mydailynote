...
\documentclass[aps,prb,amsmath,amssymb,preprint,superscriptaddress]{revtex4-1}
...
\begin{figure}[htb]
 ...
 \subfloat[][]{\includegraphics[width=0.3\textwidth]{cobosonCooper/lambda1.eps}\label{fig:lambda}}\qquad
\subfloat[][]{\includegraphics[width=0.3\textwidth]{cobosonCooper/direct1.eps}\label{fig:direct}}\\
 \subfloat[][]{\includegraphics[width=0.4\textwidth]{cobosonCooper/chi1.eps}\label{fig:chi}} 
...
\input{cobosonRichardsonConclusion}
%\appendix
%\input{cobosonCooper/appendix}
