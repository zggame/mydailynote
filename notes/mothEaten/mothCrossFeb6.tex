...
Urbana-Champaign, and Tony Leggett in particular, for enlightening discussions during her various invitations which led to the present work. 
...
\bibinfo{author}{M.~{Combescot}}, \bibinfo{author}{G.~{Zhu}},
  \bibinfo{journal}{Eur.Phys.J.B,}  (\bibinfo{year}{2011}). \bibinfo{note}{To
  be published}.
  %Type = Article
...
\bibinfo{author}{W.~V. Pogosov}, \bibinfo{author}{M.~Combescot},
 \bibinfo{year}{(2011)}, \bibinfo{note}{submitted to Phys. Rev. B}.
%Type = Article
