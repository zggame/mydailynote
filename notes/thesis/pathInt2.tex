...
\end{equation}
Here both $\Delta_{1}$ and $\Delta_{2}$ are their mean-field (saddle point) value.  It can be verified that $\zeta\ll1$ (See Appendix \ref{sec:pathApp:consistency}).  
...
\approx{}E_{\vk}-v_{\vk}^{2}\zeta\frac{\eta}{\xi_{\vk}+\eta}\Delta_{1}\label{eq:pathInt2:xiExpand2}\\
