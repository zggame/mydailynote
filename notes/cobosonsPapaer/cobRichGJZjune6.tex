...
function ansatz compared to Richardson's exact form, in the light of our coboson formalism. 
\end{abstract}
...
\end{equation}
 which has similarity with Eqs. (\ref{eq:betaH},\ref{eq:vbeta}). This operator is such that $V^+_i\left|0\right>=0$, as readily seen from the above equation acting on vacuum.  From it, we construct the interaction scatterings of two excitons through
 \begin{equation}  
...
**********************************************
There were several discussions about the difference and relation between BCS ansatz and Richardson solution, or more generally an Bethe ansatz in the form of $\prod_iB^\dagger_i\left|0\right>$ from various perspectives and physical situation \cite{bang,hasegawa}.  The discussion usually focused on the correct energy or a few other physical quantities, instead of wave function itself.
...
little soldiers, all walking similarly''.  This picture however seems a naive extrapolation to composite bosons, of the standard Bose-Einstein condensation demonstrated in the case of  \emph{elementary} bosons. It is hard for us to accept that, in the case of composite bosons, Pauli blocking between fermionic components is not destroying this nice harmony.
More work on the validity of the BCS 
ansatz in the thermodynamical limit in the context of the coboson nature of Cooper pairs, seems to us necessary to more deeply understand some unexpected aspects of basic superconductivity as the ones at the origin of Eq.(1) for the $N$-pair ground state energy. The coboson many-body formalism we have here constructed should appear as quite valuable because it gives a fresh view to this famous field, its Shiva diagram representation helping to support physical understanding.
 

\section{Conclusion}

We have constructed a coboson formalism for the electron pairs on which Cooper pairs are made, which has similarity with the one we have constructed for composite boson excitons. This formalism evidences that the scatterings of two zero-momentum pairs in the BCS potential, are mediated by the Pauli exclusion principle. No direct process exists
...
\bibitem[{\citenamefont{Gaudin}(1995)}]{gaudin}
\bibinfo{author}{\bibfnamefont{M.} \bibnamefont{Gaudin}}, 
  \emph{\bibinfo{booktitle}{\'{E}tats Propres et Valeurs Propres de l'Hmiltonien d'Appariement}} (\bibinfo{publisher}{Les \'{E}ditions de Physique, France},
  \bibinfo{year}{1995}).
...
\bibitem[{\citenamefont{Ortiz et~al.}(2005)\citenamefont{Ortitz, Somma, Dukelsky and Rombouts}}]{ortiz}
\bibinfo{author}{\bibfnamefont{G.}~\bibnamefont{Ortiz}},
  \bibinfo{author}{\bibfnamefont{R.} \bibnamefont{Somma}},
	 \bibinfo{author}{\bibfnamefont{J.} \bibnamefont{Dukelsky}},
  \bibnamefont{and} \bibinfo{author}{\bibfnamefont{S.}
  \bibnamefont{Rombouts}}, \bibinfo{journal}{Nucl. Phys. B}
  \textbf{\bibinfo{volume}{707}}, \bibinfo{pages}{421} (\bibinfo{year}{2005}).
...
\bibinfo{author}{\bibfnamefont{J.}~\bibnamefont{von Delft}},
...
\bibitem[{\citenamefont{Sierra Dukelsky Dussel von Delft Braun}(2000)\citenamefont{Sierra, Dukelsky, Dussel, von Delft and Braun}}]{sierra2000}
\bibinfo{author}{\bibfnamefont{G.} \bibnamefont{Sierra}},
\bibinfo{author}{\bibfnamefont{J.} \bibnamefont{Dukelsky}},
\bibinfo{author}{\bibfnamefont{G. G.} \bibnamefont{Dussel}},
\bibinfo{author}{\bibfnamefont{J.}~\bibnamefont{von Delft}},
  \bibnamefont{and} \bibinfo{author}{\bibfnamefont{F.} \bibnamefont{Braun}},
  , \bibinfo{journal}{Phys. Rev. B}
  \textbf{\bibinfo{volume}{61}}, \bibinfo{pages}{R11890} (\bibinfo{year}{2000}).

  
\bibitem[{\citenamefont{Schechter Imry Levinson von Delft}(2001)\citenamefont{Schechter, Imry, Levinson and von Delft}}]{schechter2001}
\bibinfo{author}{\bibfnamefont{M.} \bibnamefont{Schechter}},
\bibinfo{author}{\bibfnamefont{Y.} \bibnamefont{Imry}},
\bibinfo{author}{\bibfnamefont{Y.} \bibnamefont{Levinson}},
\bibnamefont{and} \bibinfo{author}{\bibfnamefont{J.}~\bibnamefont{von Delft}},
    , \bibinfo{journal}{Phys. Rev. B}
  \textbf{\bibinfo{volume}{63}}, \bibinfo{pages}{214518} (\bibinfo{year}{2001}).
...
\bibinfo{author}{\bibfnamefont{G.} \bibnamefont{Ortiz}}
  ...
  \bibinfo{pages}{043611} (\bibinfo{year}{2005}).
	...
	\bibitem[{\citenamefont{Bang Krumlimde}(1970)}]{bang}
\bibinfo{author}{\bibfnamefont{J.} \bibnamefont{Bang}}
  \bibnamefont{and} \bibinfo{author}{\bibfnamefont{J.}~\bibnamefont{Krumlimde}},
  \bibinfo{journal}{Nucl. Phys. A} \textbf{\bibinfo{volume}{141}},
  \bibinfo{pages}{18} (\bibinfo{year}{1970}).
	
		\bibitem[{\citenamefont{Hasegawa Tasaki}(1987)}]{hasegawa}
\bibinfo{author}{\bibfnamefont{M.} \bibnamefont{Hasegawa}}
  \bibnamefont{and} \bibinfo{author}{\bibfnamefont{S.}~\bibnamefont{Tasaki}},
  \bibinfo{journal}{Phys. Rev. C} \textbf{\bibinfo{volume}{35}},
  \bibinfo{pages}{1508} (\bibinfo{year}{1987}).
