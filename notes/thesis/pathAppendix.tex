...
More specifically, the two-body \sch equation in the momentum space reads as 
\begin{equation}
...
Now we check whether the corrections in Fermionic spectrum (Eq. \ref{eq:pathInt2:xiExpand3}-\ref{eq:pathInt2:xiExpand3}), 
