...
public class Eval {
	 ...
	 * Example Eval result.qbsh.2011.txt output/summary/report.2011.txt path/for/output/individual/file/result
	 * 
				...
				while ((str = reader.readLine()) != null) {
					...
					String outputPath;
                                        if (args.length>1) {
                                            ...
                                            String basename=outputPath+"/"+type+"_"+s.next()+"_"+s.next();
