...
-\frac{m}{4\pi{\tilde{a}_{s}(\mu,\lambda_{1})}}(\frac{\lambda_{2}}{\Delta_{1}})
	%\tag{ \ref{eq:pathInt2:gapRenorm}}
	\\
N_{\text{open}}\approx\sum{\br{\nth{2}-\frac{\xi_\vk}{2E_\vk}}+\sum\frac{E_\vk-\xi_\vk}{2E_\vk}\frac{\Delta_{1}}{2(E_{\vk}+\xi_{\vk}+\eta)}\zeta -\sum\frac{\Delta_{1}^{3}}{4E_\vk^{3}}\zeta}%\tag{\ref{eq:pathInt2:openNum}}
\end{gather}
