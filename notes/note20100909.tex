...
\begin{gather}
u^{2}_{\vk}+v^{2}_{\vk}+w^{2}_{\vk}=1\\
u_{\vk}v_{\vk}=F_{\vk}\\
u_{\vk}w_{\vk}=G_{\vk}
\end{gather}
Take the root that $u_{\vk}$ goes in the same direction as $F_{\vk}$
\begin{equation}
\begin{split}
u^{2}=&\frac{1}{2} \left(1+\sqrt{1-4 F^2-4 G^2}\right)\\
v^{2}=&\frac{2 F^2}{1+\sqrt{1-4 F^2-4 G^2}}\\
w^{2}=&\frac{2 G^2}{1+\sqrt{1-4 F^2-4 G^2}}
\end{split}
\end{equation}
Derivatives over $F_{\vk}$ are
\begin{equation}
\begin{split}
\pdiff{u^{2}}{F}=&-\frac{2 F}{\sqrt{1-4 F^2-4 G^2}}\\
\pdiff{v^{2}}{F}=&\frac{2 F}{\sqrt{1-4 F^2-4 G^2}}-\frac{8 F G^2}{\sqrt{1-4 F^2-4 G^2} \left(1+\sqrt{1-4 F^2-4 G^2}\right)^2}\\
\pdiff{w^{2}}{F}=&\frac{8 F G^2}{\sqrt{1-4 F^2-4 G^2} \left(1+\sqrt{1-4 F^2-4 G^2}\right)^2}
=\frac{F G^2 \left(1-\sqrt{1-4 F^2-4 G^2}\right)^2}{2\sqrt{1-4 F^2-4 G^2} (F^2 + G^2)^2}
\end{split}
\end{equation}
Similarly, the derivative over $G_{\vk}$ can be obtained by exchange $F_{\vk}$ ($v_{\vk}$) and $G_{\vk}$ ($w_{\vk}$).
\begin{equation}
\begin{split}
\pdiff{u^{2}}{G}=&-\frac{2 G}{\sqrt{1-4 F^2-4 G^2}}\\
\pdiff{w^{2}}{G}=&\frac{8 F ^{2}G}{\sqrt{1-4 F^2-4 G^2} \left(1+\sqrt{1-4 F^2-4 G^2}\right)^2}
=\frac{F^{2}G \left(1-\sqrt{1-4 F^2-4 G^2}\right)^2}{2\sqrt{1-4 F^2-4 G^2} (F^2 + G^2)^2}\\
\pdiff{v^{2}}{G}=&\frac{2 G}{\sqrt{1-4 F^2-4 G^2}}-\frac{8 F ^{2}G}{\sqrt{1-4 F^2-4 G^2} \left(1+\sqrt{1-4 F^2-4 G^2}\right)^2}
\end{split}
\end{equation}
