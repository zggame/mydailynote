...
-E_{b}^{(0)}\phi_{0\,\vp}=\epsilon_{\vp}\phi_{0\,\vp}-\sum_{\vk}V_{\vp\vk} \phi_{0\,\vk}
\end{equation}
...
\begin{equation}
\alpha\br{-E_{b}+\eta-2\mu-\sum_{\vk\vk'}{\phi_{\vk'}}^{*}{(E_{\vk}-\xi_{\vk})}\phi_{\vk}
...
\lambda_{1}(\eta)\equiv\sum_{\vk\vk'}{\phi_{\vk'}}^{*}{(E_{\vk}-\xi_{\vk})}\phi_{\vk}
	-\sum_{\vk\vk'}{\phi_{\vk'}}^{*}{v_{\vk}^{2}V_{\vk\vk'}}\phi_{\vk}
\end{equation}
...
\begin{equation*}
\lambda_{1}(\eta)\equiv\sum_{\vk\vk'}{\phi_{\vk'}}^{*}{v_{\vk}^{2}(2E_{k}-V_{\vk\vk'}})\phi_{\vk}
\end{equation*}
