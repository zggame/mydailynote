...
\end{align}
  These two equations full determine the wave-function. 
We introduce two quantities:
\begin{align}
\Delta_\vk^U&=\sum_{\vk'}\sin2\theta_{\vk'}(U\cos\phi_{\vk'}+Y_{\vk'}\sin\phi_{\vk'})\label{eq:gap1}\\
\Delta_\vk^V&=\sum_{\vk'}\sin2\theta_{\vk'}(V\sin\phi_{\vk'}+Y_{\vk'}\cos\phi_{\vk'})\label{eq:gap2}
\end{align} 
