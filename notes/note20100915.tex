...
\nth{t_{0}}=-\sum_{\vk'}\sqrt{(1-4G_{\vk'}^{2})}
\br{\nth{\epsilon_{\vk'}}-\nth{\sqrt{(\epsilon_{\vk'}^{2}+\Delta^{2}+2G_{\vk'}^{2}\eta\epsilon_{\vk'})}}}
\end{equation}
Noted that $t_{0}$ is the scattering amplitude for a reduced density of energy by factor $\sqrt{(1-4G_{\vk'}^{2})}$.  
\begin{gather}
t_{0}=\br{1-\tilde{U} K}^{-1}\tilde{U}\\
\tilde{U}_{\vk\vk'}=\nth{2} \br{U_{\vk\vk'}+\frac{Y_{\vk\vk''}Y_{\vk''\vk'}}{2(E^{0}-\eta)}}\label{eq:20100915:tu}\\
K=\frac{\sqrt{1-4G_{\vk}^{2}}}{\epsilon_{\vk}}\delta_{\vk\vk'}
\end{gather}
