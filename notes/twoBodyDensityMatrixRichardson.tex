...
\begin{figure}[htb]
\centering
  \subfloat[][]{\includegraphics[width=0.3\textwidth]{image/tbdm2pair1.eps}\label{fig:tbdm2pair1}}\qquad
 \subfloat[][]{\includegraphics[width=0.3\textwidth]{image/tbdm2pair2.eps}\label{fig:tbdm2pair2}}\qquad
  \subfloat[][]{\includegraphics[width=0.3\textwidth]{image/tbdm2pair1.eps}\label{fig:tbdm2pair3}}\\
 \subfloat[][]{\includegraphics[width=0.3\textwidth]{image/tbdm2pair2.eps}\label{fig:tbdm2pair4}}\qquad
  \subfloat[][]{\includegraphics[width=0.3\textwidth]{image/tbdm2pair1.eps}\label{fig:tbdm2pair5}}\qquad
 \subfloat[][]{\includegraphics[width=0.3\textwidth]{image/tbdm2pair2.eps}\label{fig:tbdm2pair6}}\\
  \subfloat[][]{\includegraphics[width=0.4\textwidth]{image/tbdm2pair7.eps}\label{fig:tbdm2pair7}} 
