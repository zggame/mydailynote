...
why  $N(N-1)$ dependence of the $N$-pair ground state energy we recently obtained by solving Richardson's equations analytically in the low density limit, stays valid up to the dense regime, no higher order dependence exists even under large overlap, a surprising result hard to accept at first. We also briefly question the BCS wave
