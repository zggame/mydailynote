...
This thesis is organized as following.  Chapter \ref{sec:intro:one} reviews several important concepts about ultra-cold alkali gas.  Chapter \ref{sec:intro:as} examines the idea of ``universality'', which is one of the central ideas in our treatment of two-channel model.  Chapter \ref{sec:intro:twobody} briefly goes over the Feshbach resonance in two-body physics, where concept of  narrow (broad) resonance is introduced. Chapter \ref{sec:intro:1channel} reviews the single-channel BEC-BCS crossover problem and the path-integral approach to solve it, which serves as the starting point in the two-channel model. In Chapter \ref{ch:path2}, my work about the narrow resonance problems in two channels is  presented in details. I also studied this problem using BCS ansatz  approach in mean-field level, and it is included as Appendix \ref{ch:mean}.  Chapter \ref{ch:conclusion} discusses and concludes our approach.  
...
\chapter{Universality,  Bethe-Peierls boundary condition, s-wave scattering length, two-body density matrix\label{sec:intro:as}}
